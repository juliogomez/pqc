...
| # | Lab | What you'll do |
|---|-----|----------------|
| 1 | [Key Exchange](key-exchange/README.md) | Negotiate a hybrid **DH + ML-KEM** key exchange over a real IKEv2 handshake, capture it, compare classical vs hybrid packet for packet, then reach quantum safety a different way with a **post-quantum preshared key**. |
